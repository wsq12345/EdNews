<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editNews.aspx.cs" Inherits="src_logon_editNews" ValidateRequest="false"%>
...
<body>
    ...
    <textarea id="content1" cols="100" rows="8" style="width:1000px;height:400px;visibility:hidden;" runat="server"></textarea>
        ...
        <asp:Button ID="Button1" runat="server" Text="提交内容" onclick="Button1_Click" /> &nbsp;<asp:Button 
            ID="Button2" runat="server" onclick="Button2_Click" Text="返回" Width="57px" />
        (提交快捷键: Ctrl + Enter)
    </div>
    </form>
</body>
